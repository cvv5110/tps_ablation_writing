...
The energy source term for the $j$-th component,
\begin{equation}
    \cQnet^{(j)}(x,t) = \sum_{i\in\cV_j}\left(\cQ^{(j)}_{\text{in},i}(x,t) - \cQ^{(j)}_{\text{out},i}(x,t)\right)\label{eqn_net_volumetric_energy}
\end{equation}
