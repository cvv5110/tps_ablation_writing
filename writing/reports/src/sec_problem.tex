...
Consider the $n$-th component with length $\ell^{(i)}$ illustrated in Fig.~\hl{x}, and for simplicity, assume that the material properties are independent of temperature.
