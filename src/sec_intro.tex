...
\begin{enumerate}
    \item Extend the previous formulation from Ref.~\cite{VargasVenegas2025} to model the transient thermo-ablative response of multi-layered hypersonic TPS through a systematic coarse-graining procedure based on the Mori-Zwanzig formalism.
