...
\end{equation}
Note that the dataset contains only surface temperature observables -- all high-fidelity information regarding the surface displacements \textit{are assumed to be unavailable during learning}.
